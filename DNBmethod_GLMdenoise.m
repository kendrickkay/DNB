function model = DNBmethod_GLMdenoise(dataset,figuredir,hrf)
...
%
% Apply GLMdenoise to the data and return an estimate of the 
...
results = GLMdenoisedata(dataset.design,dataset.data,dataset.stimdur,dataset.tr, ...
                         [],[], ...
                         struct('seed',0,'bootgroups',dataset.runtypes,'wantpercentbold',0), ...
                         figuredir);
