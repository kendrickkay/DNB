function model = DNBmethod_GLMretro2(dataset,figuredir,hrf)
...
% RETROICOR+RVHRCOR regressors removed.  Return an estimate of the task-related 
...
% obtain the version of the data that has had the RETROICOR+RVHRCOR regressors 
% removed.  call GLMdenoisedata on these data, but do not use any PCs.
results = GLMdenoisedata(dataset.design,dataset.dataRETRO2,dataset.stimdur,dataset.tr, ...
                         'assume',hrf, ...
